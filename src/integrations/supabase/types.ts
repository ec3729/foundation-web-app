  ...
  public: {
    Tables: {
      ...
      canvassing_sessions: {
        ...
        Relationships: [
          {
            foreignKeyName: "canvassing_sessions_volunteer_id_fkey"
      ...
      corrections: {
        Row: {
          business_id: string | null
          corrected_business_name: string | null
          corrected_notes: string | null
          corrected_public_business: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "corrections_zone_id_fkey"
            columns: ["zone_id"]
            isOneToOne: false
